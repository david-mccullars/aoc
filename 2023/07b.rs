...
fn score(cards: &Hand) -> u8 {
    ...
    if wild == 5 {
        FIVE_OF_A_KIND
    } else if groups[0] + wild == 5 {
        FIVE_OF_A_KIND
    } else if groups[0] + wild == 4 {
        FOUR_OF_A_KIND
    } else if groups[0] + wild == 3 && groups[1] == 2 {
        FULL_HOUSE
    } else if groups[0] == 3 && groups[1] + wild == 2 {
        FULL_HOUSE
    } else if groups[0] + wild == 3 {
        THREE_OF_A_KIND
    } else if groups[0] + wild == 2 && groups[1] == 2 {
        TWO_PAIR
    } else if groups[0] == 2 && groups[1] + wild == 2 {
        TWO_PAIR
    } else if groups[0] + wild == 2 {
        ONE_PAIR
    } else if wild > 0 {
        eprintln!("We didn't use all wilds: {:?}", cards);
        std::process::exit(1);
    } else {
        HIGH_CARD
    }
